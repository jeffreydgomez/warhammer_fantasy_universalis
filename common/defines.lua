...
NDiplomacy = {
	...
	CELESTIAL_EMPIRE_MANDATE_PER_HUNDRED_NONTRIBUTARY_DEV = -0.33,	-- Yearly change of Mandate for each hundred development of neighbouring states that are not the Emperor's tributaries # WAR In vanilla this is 0, though in older versions it was higer.
