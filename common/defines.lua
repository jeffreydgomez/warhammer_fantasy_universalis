...
NDiplomacy = {
	...
	MIN_RELATIONS_TO_ALLY = -150,						-- Alliances not possible if either country has an opinion of the other lower than this # WAR This is normally -200
	...
	CELESTIAL_EMPIRE_MANDATE_PER_HUNDRED_DEVASTATION = -24.0,	-- Yearly change of Mandate for each hundred devastated development (scaled to devastation). # WAR this is normally -12.0
	...
	CELESTIAL_EMPIRE_MANDATE_PER_HUNDRED_NONTRIBUTARY_DEV = -1.00,	-- Yearly change of Mandate for each hundred development of neighbouring states that are not the Emperor's tributaries # WAR In vanilla this is 0, though in older versions it was higer.
	CELESTIAL_EMPIRE_MANDATE_FROM_DEFENDING = 5,	-- How much Mandate is gained when successfully defending the Emperor title.
	CELESTIAL_EMPIRE_MANDATE_PER_5_LOANS = -1.0,	-- Yearly change of Mandate for every 5 loans.	# WAR this is normally -0.6
...
NMilitary = {
	...
	LEADER_WORK_YEARS_DEATH_FACTOR = 4,				-- Divides how many years he has been working to calculate chance ## WAR WAS 2
	LEADER_AGE_DEATH_FACTOR = 9999999,					-- Divides age with this to calculate chance   ### WAR WAS 3
...
NNationDesigner = {
	...
	MANDATE_SUBCONTINENT_NAME = "northern_south_lands_superregion", -- Name of the subcontinent where the Mandate will be given to the biggest nation by development when using random generated nations # WAR this used to be china_superregion
},
